...
def dehazeformer_t(in_channels=3, out_channels=4, window_size=8):
    return DehazeFormer(
        in_channels=in_channels,
        out_channels=out_channels,
        window_size=window_size,
...
def dehazeformer_s(in_channels=3, out_channels=4, window_size=8):
    return DehazeFormer(
        in_channels=in_channels,
        out_channels=out_channels,
        window_size=window_size,
...
def dehazeformer_b(in_channels=3, out_channels=4, window_size=8):
    return DehazeFormer(
        in_channels=in_channels,
        out_channels=out_channels,
        window_size=window_size,
...
def dehazeformer_d(in_channels=3, out_channels=4, window_size=8):
    return DehazeFormer(
        in_channels=in_channels,
        out_channels=out_channels,
        window_size=window_size,
...
def dehazeformer_w(in_channels=3, out_channels=4, window_size=8):
    return DehazeFormer(
        in_channels=in_channels,
        out_channels=out_channels,
        window_size=window_size,
...
def dehazeformer_m(in_channels=3, out_channels=4, window_size=8):
    return DehazeFormer(
        in_channels=in_channels,
        out_channels=out_channels,
        window_size=window_size,
...
def dehazeformer_l(in_channels=3, out_channels=4, window_size=8):
    return DehazeFormer(
        in_channels=in_channels,
        out_channels=out_channels,
        window_size=window_size,
...
if __name__ == "__main__":
    x = torch.randn(1, 305, 64, 64).float().cuda()
    mcplb = dehazeformer_b(in_channels=305, out_channels=306).cuda()
    out = mcplb(x)

    # With torchinfo, you can use input_size
    summary(mcplb, input_size=(1, 305, 64, 64))
